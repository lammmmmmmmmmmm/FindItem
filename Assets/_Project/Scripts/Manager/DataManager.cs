...
public class DataManager : Singleton<DataManager> {
        ...
        get {
            if (_settingsData == null) {
                if (!PlayerPrefs.HasKey(SETTINGS_DATA_KEY)) {
                    ...
                    _settingsData =
                        JsonConvert.DeserializeObject<SettingsData>(PlayerPrefs.GetString(SETTINGS_DATA_KEY));
                }
            }
    ...
    public GameSessionData GameSessionData => _gameSessionData ??= new GameSessionData();
    ...
    public void ResetGameSessionData() {
        GameSessionData.totalCoinCollected = 0;
        GameSessionData.totalDiamondCollected = 0;
    }
    
    #endregion
    
    #region Game Mode Data
...
public class GameSessionData {
    ...
    public int totalDiamondCollected;
}
